...
The dataset used in this project consists of IPL team data, including:
    ...
    • Matches Played (M)
    • Wins (W) and Losses (L)
    • Net Run Rate (NRR) — runs scored per over minus runs conceded per over
    • Points (2 per win, 1 per no-result, 0 per loss)
    • Historical Win Percentage (all-time IPL data, 2008–2025)
This data is used to perform statistical analysis, create visualizations, build regression and cluster models, and predict match winners.
